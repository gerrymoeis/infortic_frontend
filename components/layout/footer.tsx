    ...
    <footer className="mt-auto border-t border-gray-200 bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        <div className="grid gap-8 md:grid-cols-3">
          {/* About */}
          <div>
            <h3 className="mb-3 text-sm font-semibold text-gray-900">Tentang Infortic</h3>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="mb-3 text-sm font-semibold text-gray-900">Tautan Cepat</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/opportunities" className="text-gray-600 hover:text-primary-600">
                  Semua Peluang
                </Link>
              </li>
              <li>
