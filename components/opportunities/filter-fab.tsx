...
export function FilterFAB({ activeFilterCount, onClick }: FilterFABProps) {
  return (
    <button
      onClick={onClick}
      className="fixed bottom-6 right-6 z-fab flex h-14 w-14 items-center justify-center rounded-full bg-primary-600 text-white shadow-lg transition-all duration-150 hover:bg-primary-700 hover:shadow-xl active:scale-95 lg:hidden"
